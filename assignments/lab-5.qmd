...
1. Find a public API. There are countless services that provide data through an API. This usually requires a free registration to obtain an API key.
    + Ideas for inspiration:
      ...
      - [The Movie Database (TMDB)](https://developer.themoviedb.org/docs/getting-started) — Information about movies, actors, etc.
      - [FRED](https://fred.stlouisfed.org/docs/api/fred/) — Economic data (as seen in the lecture).
      - [NASA APIs](https://api.nasa.gov/) — Data and photos from NASA.
